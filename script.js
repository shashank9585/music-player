...
songIndex = 0;
songs = ['beyonce.mp3', 'dontstartnow1.mp3']; // object storing paths for audio objects
thumbnails = ['lemonade.png', 'dontstartnow.png']; // object storing paths for album covers and backgrounds
